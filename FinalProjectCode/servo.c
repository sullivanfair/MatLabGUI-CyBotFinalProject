...
{
//    uint32_t lowPulse = 313029 - ((313029 - 284392) / 180) * degrees;   //cybot 6
//    uint32_t lowPulse = 313464 - ((313464 - 286420) / 180) * degrees;   //cybot 7
//    uint32_t lowPulse = 313151 - ((313151 - 285045) / 180) * degrees;   //cybot 12
    uint32_t lowPulse = 312024 - ((312024 - 284135) / 180) * degrees;   //cybot 9
